...
**Architecture: LLM-First** — The server exposes atomic, well-filtered data tools. The LLM (Codex) handles all orchestration, analysis, and synthesis. No analytics logic lives in the server.
